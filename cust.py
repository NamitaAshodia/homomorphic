...
def storeKeys():
	...
	with open('C:/Users/namit/OneDrive/Desktop/Homomorphic-Encryption-master/Homomorphic-Encryption-master/custkeys.json', 'w') as file: 
		json.dump(keys, file)

def getKeys():
	with open('C:/Users/namit/OneDrive/Desktop/Homomorphic-Encryption-master/Homomorphic-Encryption-master/custkeys.json', 'r') as file: 
		keys=json.load(file)
